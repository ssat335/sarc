...
class dataProcess(object):
    ...
    def __init__(self, out_rows, out_cols, data_path = "./aug_train_combined", label_path = "./aug_label_combined", test_path = "./test", npy_path = "./npydata", img_type = "png"):
    ...
    def create_train_data(self):
        ...
        for imgname in imgs:
            ...
            data_name = midname[0:midname.rindex("_")] + "_train.png"
            label_name = midname[0:midname.rindex("_")] + "_label.png"
            img = load_img(self.data_path + "/" + data_name,grayscale = True)
            label = load_img(self.label_path + "/" + label_name,grayscale = True)
